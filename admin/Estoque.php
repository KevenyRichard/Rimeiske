...
$sqllocal = "SELECT * FROM produto p JOIN produto_local f ON f.fk_produto = p.cod_produto JOIN local l ON f.local_atual = l.cod_local WHERE categoria = 0;";
...
if (isset($_POST['btnExcluir'])) {
    ...
    if ($stmt->execute()) {
        if ($stmtdel->execute()) {
            ...
            $_SESSION['alert'] = "Item Excluido Do Sistema De Patrimônio!";
        ...
        $_SESSION['alertTitle'] = "Erro Ao Tentar Excluir Item";
                ...
                <thead>
                    <th colspan="10">
                        <div class="Acoes_produtos">
                            <a class="btn btn_adicionarProduto btn_verde" href="AddPatrimonio.php">Adicionar Produto</a>
                        </div>
                        <b class="title_estoque">Patrimônio Informatica</b>
                        <div class="estoque_produtos">
                            <a class="btn btn_verde" href="estoqueTemp.php">Estoque De Produtos</a>
                        </div>
                    </th>
                    <tr class="chamados-info">
                        ...
                        <th id="patrimonio">Patrimônio</th>
                        <th id="local_original">Localização Original</th>
                ...
                <tbody>
                    ...
                    foreach($itensPagina as $produtos){?>
                        <tr class="informacoes">
                            ...
                            <td><?php echo $produtos['patrimonio']?></td>
                            <?php
                                $local = $produtos['local_original'];
                                $sqlnome = "SELECT nome_local FROM local WHERE cod_local = $local;";
